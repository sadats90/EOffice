    ...
    jQuery.fn.sheepIt = function (options){
        ...
        function clickOnRemoveCurrent(event)
        {
            ...
            if (typeof options.beforeRemoveCurrent === "function") {
                options.beforeRemoveCurrent(source, event);
            }
            ...
            if (typeof options.afterRemoveCurrent === "function") {
                options.afterRemoveCurrent(source, event);
            }
        }
...
function ConfirmForm(formId){
    $.confirm({
        title: '<span style="color: #ff0000;"><i class="fa fa-exclamation-triangle"></i> অনুমোদন করবেন কি না?</span>',
        content: '<span>Are you sure to confirm this action?</span>',
        buttons: {
            cancel: {
                text: 'No',
                btnClass: 'btn-danger',
...
function ConfirmActiveDeactiveUser(formId,action){
    $.confirm({
        title: '<span style="color: #ff0000;"><i class="fa fa-exclamation-triangle"></i> অনুমোদন করবেন কি না?</span>',
        content: '<span>Are you sure you want to '+action+' this user?</span>',
        buttons: {
            cancel: {
                text: 'No',
                btnClass: 'btn-danger',
