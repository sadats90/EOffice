...
@section('title', ' এনওসি সনদপত্রের শর্তাদি যোগ')
@section('content')
    <p class="m-0 text-black-50"> এনওসি সনদপত্রের শর্তাদি যোগ</p>
    <hr>
    <!-- Top Statistics -->
    <div class="card card-default">
        ...
        <div class="card-body container">
            ...
            <form action="{{ route('CertificateText/Store') }}" method="post">
                @csrf
                <div class="form-group">
                    <label for="name" class="col-form-label-sm">শিরোনাম</label>
                    <input type="text" name="title" id="title" value="{{ old('title') }}" required autofocus class="form-control @error('title') is-invalid @enderror">
                    @error('name')
                ...
                <div class="form-group">
                    <label for="body_text" class="col-form-label-sm">বিস্তারিত</label>
