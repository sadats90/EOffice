               ...
               <div class="card-header">
                   <div class="row">
                       ...
                       <div class="col-md-6 text-right">
                           <a href="{{ route('complete') }}" class="btn btn-primary btn-sm"><i class="fas fa-arrow-up"></i> সম্পুর্ন আবেদন সমূহ</a>
                       </div>
                   </div>
               </div>
               <div class="card-body">
                           ...
                           <table class="table table-bordered table-striped table-sm">
                               ...
                               @foreach($letter_issues as $letter)
                                   <tr>
                                       ...
                                       <td>{{ \App\Http\Helpers\Helper::ConvertToBangla(date('d/m/Y', strtotime($letter->expired_date))) }}</td>
