...
@section('title', 'একই স্বারকে প্রতিস্থাপন')
@section('content')
    <p class="m-0 text-black-50">একই স্বারকে প্রতিস্থাপন</p>
    <hr>
    <!-- Top Statistics -->
    <div class="row">
       <div class="col-md-12">
                                       ...
                                       <td class="text-center">
                                           <div class="dropdown show">
                                               ...
                                               <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                   <a class="dropdown-item" href="{{ route('complete/app_view',['id'=>encrypt($na->id)]) }}" target="_blank"><i class="fas fa-file-alt"></i> আবেদন পর্যালোচনা</a>
                                                   <a class="dropdown-item" href="{{ route('complete/paper_view',['id'=>encrypt($na->id)]) }}" target="_blank"><i class="fas fa-file"></i> ডকুমেন্ট পর্যালোচনা</a>
                                                   <a class="dropdown-item" href="{{ route('complete/report_view',['id'=>encrypt($na->id)]) }}" target="_blank"><i class="far fa-clipboard"></i> আবেদন রিপোর্ট</a>
                                                   <a class="dropdown-item" href="{{ route('complete/letters',['id'=>encrypt($na->id)]) }}" target="_blank"><i class="far fa-envelope"></i> চিঠি সমূহ</a>
                                                   <a class="dropdown-item" href="{{ route('complete/certificate',['id'=>encrypt($na->id)]) }}" target="_blank"><i class="far fa-file"></i> সনদপত্র</a>
                                                   <a class="dropdown-item" href="{{ route('SwarakReplacement/details',['id'=>encrypt($na->id)]) }}" target="_blank"><i class="far fa-file"></i> একই স্বারকে প্রতিস্থাপনের তথ্য</a>
                                               </div>
                                           </div>
                                       </td>
                                   </tr>
