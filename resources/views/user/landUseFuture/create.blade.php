...
@section('title', 'জমির ভবিষ্যত ব্যবহার যোগ')
@section('content')
    <p class="m-0 text-black-50">জমির ভবিষ্যত ব্যবহার যোগ করুন</p>
    <hr>
    <!-- Top Statistics -->
    <div class="card card-default">
        <div class="card-header card-header-border-bottom p-3">
            <div class="col-md-6">
                জমির ভবিষ্যত ব্যবহার যোগ করুন
            </div>
        ...
        <div class="card-body p-2">
          ...
          <div class="row">
                <div class="col-md-8 offset-2">
                  <form action="{{ route('LandUseFuture/Store') }}" method="post">
                      @csrf
                        <div class="form-group">
                            <label for="flut_name" class="col-form-label-sm">জমির ভবিষ্যত ব্যবহার<small class="text-danger">*</small></label>
                            <input type="text" name="flut_name" id="flut_name" value="{{ old('flut_name') }}" required autofocus class="form-control form-control-sm @error('flut_name') is-invalid @enderror">
                      ...
                      <div class="form-group">
                            ...
                            <input type="text" name="cost" id="cost" value="{{ old('cost') }}" required autofocus class="form-control form-control-sm @error('cost') is-invalid @enderror">
