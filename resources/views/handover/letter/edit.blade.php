       ...
       <div class="col-md-10 offset-1">
           <div class="card">
               <div class="card-header">
                  <div class="row">
                      ...
                      <div class="col-md-6 text-right">
                          @if($hit == 'list')
                              <a href="{{ route('Handover/Letter', ['id' => $app_id]) }}" class="btn btn-primary btn-sm"><i class="fas fa-arrow-up"></i> চিঠি সমূহ</a>
                          @else
                              <a href="{{ route('workHandover/application/forward', ['id' => $app_id]) }}" class="btn btn-primary btn-sm"><i class="fas fa-arrow-up"></i> ফিরে যান</a>
                          @endif
                      </div>
                  </div>
               </div>
               ...
               @include('includes.message')<!-- Message template -->
                    <div class="row">
                        <div class="col-12">
                            <form action="{{ route('Handover/Letter/update', ['id' => $issue_letter->id, 'app_id' => $app_id, 'hit' => $hit]) }}" method="post">
                                @csrf
