        ...
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form action="{{ route('workHandover/WaitApplication') }}" method="get" autocomplete="off">
                                        ...
                                        <table class="table table-bordered table-sm pb-5">
                                            ...
                                            @foreach($application as $i => $na)
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{ \App\Http\Helpers\Helper::ConvertToBangla($na->application->app_id) }} </td>
                                                    <td class="text-center">{{ \App\Http\Helpers\Helper::ConvertToBangla(date('d/m/Y', strtotime($na->application->submission_date))) }}</td>
                                                    <td class="text-center">{{ $na->from_user->name }}, {{ $na->from_user->designation->name }} </td>
                                                    ...
                                                    <td class="text-center">{{ \App\Http\Helpers\Helper::ConvertToBangla(\App\User::find($na->application->user_id)->mobile) }} </td>
                                                    <td class="text-center">
